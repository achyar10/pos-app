...
export const lastInvUrl = API + '/trans/lastinv'
...
export const prepaidCheck = API + '/prepaid/check'
...
export const ppobInvUrl = API + '/ppob/lastinv'

export const bankInvUrl = API + '/bank/lastinv'
